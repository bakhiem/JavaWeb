 ...
 * @author Luxury
 */
public class SoChoConLai extends HttpServlet {
...
//            String sdt = request.getParameter("sdt");
            int soghecuaxe = Integer.parseInt(request.getParameter("soChoConLai"));
//            int soghecan = Integer.parseInt(request.getParameter("soghecan"));
            ...
            session.setAttribute("soGheConLai", sogheconlai);
